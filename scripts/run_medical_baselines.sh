...
#   ./scripts/run_medical_baselines.sh 100 exp/medical_debate_n100/baselines openai
#   ./scripts/run_medical_baselines.sh 100 exp/medical_debate_n100/baselines anthropic
